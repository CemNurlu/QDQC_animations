...
#B_rot_H_drive_eq_2 = ax_dict["plot"].text(1.38, 0.0, r"$=h S \prime _x$", color = vector_colours_rot[2], alpha = 0, size = 25, math_fontfamily = math_fontfamily, ha = "center")
...
def animate(i):
    ...
    if t_4 < i <= t_5: #Rotating frame before transforming B_zeeman
        ...
        t_trans_2 = 2*trans_fraction*(t_5-t_4) + t_4
        ...
        if i <= t_trans:
            ...
            new_alpha_vector = [1-new_alpha,1,1]
            ...
            new_alpha = (i- t_trans)/(t_trans_2-t_trans)
            ...
            new_alpha_vector = [new_alpha,1,1]
            sphere_dict["bloch_rot"].vectors = []
...
cache_then_save_funcanimation(ani, f'animations/test/negative_detuning_extended.{file_type}', fps = 20 )
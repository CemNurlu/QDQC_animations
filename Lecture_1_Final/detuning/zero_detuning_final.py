...
B_rot_H_drive_eq_2 = ax_dict["plot"].text(1.38, 0.0, r"$=h S \prime _x$", color = vector_colors[2], alpha = 0, size = 25, math_fontfamily = math_fontfamily, ha = "center")
...
cache_then_save_funcanimation(ani, f'animations/test/zero_detuning_final.{file_type}', fps = 20 )
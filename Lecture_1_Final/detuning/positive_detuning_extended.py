...
def animate(i):
    ...
    if t_5 < i <= t_6: #Rotating frame after transforming B_zeeman
        ...
        if i <= t_trans:
            new_alpha = (i-t_5)/(t_trans-t_5)
            sphere_dict["bloch_rot"].vector_alpha = [new_alpha,1,0,0,0]
...
cache_then_save_funcanimation(ani, f'animations/test/positive_detuning_extended.{file_type}', fps = 20 )
...
W_trans_equation = ax_dict["plot"].text(1.6, 0.7, r'$W = \mathrm{exp}(-i \omega_2 t S_z)$', color = "black", alpha = 0, size = 25, math_fontfamily = math_fontfamily)
W_trans_arrow = FancyArrowPatch((2.75, 1.5), (2.05, 1.5), 
        # arrowstyle='->',
        mutation_scale=120,
        lw = 2, 
        ec = "black",
...
cache_then_save_funcanimation(ani, f'animations/test/bloch_coupling_different_omega_trans2_new.{file_type}', fps = 20 )
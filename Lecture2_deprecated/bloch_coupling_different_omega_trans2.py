...
omega_1_rot = omega_1_lab - omega_2_lab
omega_2_rot = 0
...
omega_equation = ax_dict["plot"].text(1.9, 0.6, r"$\omega_1 \neq \omega_2$", color = "black", alpha = 0, size = 20)
coupling_equation_lab = ax_dict["plot"].text(0.8, -0.5, r"$H_c = S^x_1 S^x_2 + S^y_1 S^y_2 + S^z_1 S^z_2$", color = "black", alpha = 0, size = 30)
coupling_equation_rot = ax_dict["plot"].text(1.7, -0.5, r"$H_c = S^z_1 S^z_2$", color = "black", alpha = 0, size = 30)


trans_equation_1 = ax_dict["plot"].text(0.55, 0.23, r'$W = \mathrm{exp}(-i \omega_2 t S_z)$', color = "black", alpha = 0, size = 15)
trans_arrow_1 = FancyArrowPatch((0.6, 0.15), (1.6, 0.15), arrowstyle = "->", 
                        mutation_scale = 20, color = "black", alpha = 0, lw=2)

trans_equation_2 = ax_dict["plot"].text(3, 0.23, r'$W = \mathrm{exp}(-i \omega_2 t S_z)$', color = "black", alpha = 0, size = 15)
...
def animate(i):
    ...
    if i == t_9:
        ...
        sphere_dict["bloch_1"].xlabel = [r"$x_2'$", '']
        sphere_dict["bloch_1"].ylabel = [r"$y_2'$", '']

        sphere_dict["bloch_2"].xlabel = [r"$x_2'$", '']
        sphere_dict["bloch_2"].ylabel = [r"$y_2'$", '']
...
cache_then_save_funcanimation(ani, f'animations/test/bloch_coupling_different_omega_trans2.{file_type}', fps = 20 )
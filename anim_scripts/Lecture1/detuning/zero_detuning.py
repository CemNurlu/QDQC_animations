...
B_lab_H_text = ax_dict["plot"].text(-1.35, 0.2, r'$H \; =$', color = "black", alpha = 0, size = 20, math_fontfamily = math_fontfamily)
...
B_rot_H_text = ax_dict["plot"].text(0.9, 0.2, r"$H \prime \; =$", color = "black", alpha = 0, size = 20, math_fontfamily = math_fontfamily)
...
B_rot_H_drive_eq_2 = ax_dict["plot"].text(1.38, 0.0, r"$h S \prime _x$", color = vector_colors[1], alpha = 0, size = 20, math_fontfamily = math_fontfamily)

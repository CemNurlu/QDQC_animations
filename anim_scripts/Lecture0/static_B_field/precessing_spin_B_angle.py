from anim_base import  (cache_then_save_funcanimation, bloch_vector, PrettyAxis, rot_matrix,file_type,
...
bloch_points_spin = np.einsum("kj, ij -> ki", bloch_points_spin, R_matrix)
B_vector = np.einsum("ij, j -> i", R_matrix, B_vector)
...
cache_then_save_funcanimation(ani, f'animations/test/precessing_spin_B_angle.{file_type}', fps = 20 )

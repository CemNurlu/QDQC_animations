...
B_rot_H_text = ax_dict["plot"].text(0.7, 0.2, r"$H' \; =$", color = "red", alpha = 0, size = 18, math_fontfamily = math_fontfamily)
...
B_lab_H_text = ax_dict["plot"].text(-1.6, 0.2, r'$H \; =$', color = "red", alpha = 0, size = 18, math_fontfamily = math_fontfamily)

...
vector_colors = ["purple", "deeppink", "deepskyblue","purple"]#, "blue", "green", vector_colors[0], "orange", "pink", "yellow"]
...
#phi_end = 4*int(18 + 3*N_add_rounds)*np.pi
...
B_rot[0,:,0] = B_x_max
B_rot[1,:,0] = B_x_max * np.cos(6*phi)
B_rot[1,:,1] = - B_x_max * np.sin(6*phi)
...
B_dec_H_equation = ax_dict["plot"].text(0.1, 2.05, r'$H_{driving}\; = \;$', color = vector_colors[0], alpha = 0, size = 30, math_fontfamily = math_fontfamily, ha = "center")
B_dec_0_equation = ax_dict["plot"].text(0.1, 1.65, r'$=\; h \: [ S_x \: \mathrm{cos} \omega t + S_y \: \mathrm{sin}\omega t ]\; +$', color = vector_colors[1], alpha = 0, size = 30, math_fontfamily = math_fontfamily, ha = "center")
B_dec_1_equation = ax_dict["plot"].text(0.1, 1.25, r'$+ \; h \: [ S_x \: \mathrm{cos} \omega t - S_y \: \mathrm{sin}\omega t ]$', color = vector_colors[2], alpha = 0, size = 30, math_fontfamily = math_fontfamily, ha = "center")

B_rot_H_equation = ax_dict["plot"].text(4.1, 2.05, r"$H \prime _{\!\!\! driving}  \; = \;$", color = vector_colors[0], alpha = 0, size = 30, math_fontfamily = math_fontfamily, ha = "center")
B_rot_0_equation = ax_dict["plot"].text(4.1, 1.65, r"$ = \; h S\prime _{\!\!\! x}   $", color = vector_colors[1], alpha = 0, size = 30, math_fontfamily = math_fontfamily, ha = "center")

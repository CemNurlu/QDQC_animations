...
B_arrow_rot_0 = FancyArrowPatch((4.1,0), (B_dec[0,0,0] + 4.1, B_dec[0,0,1]),
        arrowstyle='-|>', mutation_scale=20,
        lw = 5, color = vector_colors[1],
        alpha = 0
    )

B_arrow_rot_1 = FancyArrowPatch((4.1,0), (B_dec[1,0,0] + 4.1, B_dec[1,0,1]),
        arrowstyle='-|>', mutation_scale=20,
        lw = 5, color = vector_colors[2],
        alpha = 0
    )
...
cache_then_save_funcanimation(ani, f'animations/test/rot_frame_transformation_driving_field.{file_type}', fps = 20 )
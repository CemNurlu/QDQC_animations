...
B_lab_H_drive_eq = ax_dict["plot"].text(-1.10, 0.1, r"$h [ S_x \: \mathrm{cos}(\omega t) + S_y \: \mathrm{sin}(\omega t) ]$", color = vector_colors[1], alpha = 0, size = 20, math_fontfamily = math_fontfamily)
...
B_rot_H_drive_eq_1 = ax_dict["plot"].text(1.75, 0.1, r"$h S \prime _x = $", color = vector_colors[1], alpha = 0, size = 20, math_fontfamily = math_fontfamily)

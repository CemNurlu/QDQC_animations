...
omega_lt_omega_L = ax_dict["plot_between"].text(0.25, 0.7, r'$\omega < \omega_L$', color = "black", alpha = 0, size = 30, math_fontfamily = math_fontfamily)
...
def animate(i):
    ...
    if t_5 < i <= t_6:
        ...
        omega_lt_omega_L.set_alpha(new_alpha)
...
cache_then_save_funcanimation(ani, f'animations/test/positive_detuning_new.{file_type}', fps = 20 )
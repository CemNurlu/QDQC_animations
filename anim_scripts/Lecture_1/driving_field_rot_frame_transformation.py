...
B_rot[0,:,0] = B_x_max
B_rot[1,:,0] = B_x_max * np.cos(5*phi)
B_rot[1,:,1] = - B_x_max * np.sin(5*phi)
...
frame_text_lab = ax_dict["bloch_lab"].text(1.5, 0.8, 1,"Lab frame", color = "black", size=50, alpha=0, zorder=1000)
frame_text_rot = ax_dict["bloch_rot"].text(-1.5, -0.8, 1,"Rotating frame", color = "black", size=50, alpha=0, zorder=1000)
...
def animate(i):
    ...
    if t_0 < i <= t_13:
        ...
        if t_5 < i < t_6:
            ...
            sphere_dict["bloch_rot"].make_sphere()
            if i - t_6 < 20:
                ax_dict["bloch_lab"].text(0.4, 0.7, 0.8,"Lab frame", color = "black", size=25, alpha=(i-t_6)/20, zorder=1000)
                ax_dict["bloch_rot"].text(-1.4, -1.4, 1.07,"Rotating frame", color = "black", size=25, alpha=(i-t_6)/20, zorder=1000)
            else:
                ax_dict["bloch_lab"].text(0.4, 0.7, 0.8, "Lab frame", color = "black", size=25, alpha=1, zorder=1000)
                ax_dict["bloch_rot"].text(-1.4, -1.4, 1.07, "Rotating frame", color = "black", size=25, alpha=1, zorder=1000)

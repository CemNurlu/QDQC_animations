...
B_0 = 1.5
B_fluctuation_multiplier = 0.35
B_rand = np.random.rand(n_spins)*B_fluctuation_multiplier
...
T2_arrow = FancyArrowPatch((0.03, 0.2), (1, 0.12), 
        arrowstyle='<->', mutation_scale=20,
        lw = 1.5, color = "black",
        alpha = 0
    )

T2_text = ax_dict["plot"].text(0.34, 0.31, r'$ \sim T^*_2$', size = 30, alpha = 0, math_fontfamily = math_fontfamily)
...
T2_inv_text = ax_dict["plot"].text(0.80, -3.43, r'$ \sim 1 / \, T^*_2$', size = 30, alpha = 0, math_fontfamily = math_fontfamily)
...
cache_then_save_funcanimation(ani, f'animations/test/inhom_broadening_new.{file_type}', fps = 20 )
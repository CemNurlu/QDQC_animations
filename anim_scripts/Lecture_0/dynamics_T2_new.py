...
log_T_2_min, log_T_2_max = -1.5, 1.5
...
fourier = np.minimum(fourier,np.max(max_vals)/4)
...
T2_slider = PrettySlider(ax, (0.3, 3.8), (-0.5, -0.5), (0, 1.08),
...
cache_then_save_funcanimation(ani, f'animations/test/dynamics_T2_new.{file_type}', fps = 20 )
...
B_lab_H_text = ax_dict["plot"].text(-1.3, 0.2, r'$H \; =$', color = "black", alpha = 0, size = 20, math_fontfamily= math_fontfamily)
...
B_rot_H_text = ax_dict["plot"].text(0.87, 0.2, r"$H \prime \; =$", color = "black", alpha = 0,  size = 20, math_fontfamily= math_fontfamily)
